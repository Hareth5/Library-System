...
public class Manage extends BaseView {
    ...
    private void updateActions() { // a method to fire the actions
        ...
        write.setOnAction(e -> { // write books to a file
            try (PrintWriter printWriter = new PrintWriter(ApplicationFiles.updatedBooksFile().toFile())) {
                ...
                Handler.alert("Error", "Unable to write books file", Alert.AlertType.ERROR);
            }
        });
    }
}
