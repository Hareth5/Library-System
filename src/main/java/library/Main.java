...
public class Main extends Application {
    ...
    public static void changeScene(Node node) { // a method to switch scenes by changing the center of the main
                                                // borderpane
        main.setCenter(node);
    }
    ...
    public void start(Stage primaryStage) { // the start method
        ...
        main.setTop(new MainMenu(primaryStage).mainMenuBar()); // set the menu bar on the top for all scenes in the
                                                               // program
